...
import tqdm
from data_load import load_from_lines, load_vocab
...
def synthesize(phrases):
    ...
    with tf.Session() as sess:
        ...
        ## mel
        size = 10
        y_hat = np.zeros((texts.shape[0], size, hp.n_mels * hp.r), np.float32)  # hp.n_mels*hp.r
...
if __name__ == '__main__':
    synthesize('Соколов Олег Андреевич')
    print("Done")